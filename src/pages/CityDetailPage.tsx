      ...
      <div className="p-8 space-y-6 max-w-4xl">
        ...
        <div>
          <h3 className="flex items-center gap-2 text-sm font-semibold text-gray-900 mb-3">
            <LandPlot size={16} className="text-gray-400" />
            الأحواض
          </h3>
          {isBasinsLoading ? (
        ...
        <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
          ...
          {city.is_published ? (
            <Button variant="secondary" onClick={() => unpublishMutation.mutate(cityId)} disabled={unpublishMutation.isPending}>
              إلغاء النشر
            </Button>
          ) : (
            <Button onClick={() => publishMutation.mutate(cityId)} disabled={publishMutation.isPending}>
              نشر المدينة
            </Button>
          )}
